...
export default function ShelterMap() {
  ...
  return (
    <div style={{ width: '900px', maxWidth: '100%', marginRight: 12, marginLeft: 20, display: "inline-block", verticalAlign: "top" }}>
      ...
      <div className="shelter-map-description" style={{ width: '100%', maxWidth: 880, marginLeft: 20, marginBottom: 18, textAlign: "left", fontSize: 15, color: "#444", opacity: 0.92, lineHeight: 1.6 }}>
